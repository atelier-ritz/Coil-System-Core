...
// 	return false;
//
//     //unsigned long time = micros(); //need to find alternate way to calculate time spans
//
//     gettimeofday(&start, NULL);
//     unsigned long time  = (double) start.tv_sec*1e6 + start.tv_usec;
//
//
...
//
// 	//digitalWrite(Pin4,High) - > s826_doPin(Pin4,1)
// 	s826_doPin(_pin[i], (mask & (1 << i)) ? (1 ^ _pinInverted[i]) : (0 ^ _pinInverted[i]));
// }
//
...
// 	s826_doPin(_enablePin, 0 ^ _enableInverted);
// }
//
...
// 	s826_doPin(_enablePin, 1 ^ _enableInverted);
//     }
// }
//
